...
import edu.csc413.calculator.operators.LParenthesis;
                ...
                if (Operand.check(token)) {
                    ...
                    if(token.equals(")")) {
                        while (!(operatorStack.peek().priority() == 0)) {
                            ...
                            operandStack.push(oldOperator.execute(o1, o2));
                        }
                    ...
                    // pass in the token to the getOperator, which is also a static method
